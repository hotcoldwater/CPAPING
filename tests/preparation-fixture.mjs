...
export const saved={resume_file_id:uid,resume_docx_file_id:other,applicant_name:'지원자',mail_subject_template:'[회계법인] {이름}',mail_body_template:'{공고}',enabled:true,mode:'review',filters:{employment:['Full Time']},updated_at:'2026-09-14T10:00:00Z'};
export async function setup({rule=null,draft=null,failState=false,failSave=false,failUpload=false,failAutomation=false,mail={email:'qa@example.com',reply_read_enabled:true},steps=true}={}){
 ...
 const stored={files:[{id:other,name:'테스트_이력서.docx'},{id:uid,name:'테스트_이력서.pdf',created_at:'2026-09-14T10:00:00Z'}],rule:structuredClone(rule),draft:structuredClone(draft),applications:[],limit:100};
