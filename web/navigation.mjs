...
export function navigation(page,path='/',versions=assetVersions) {
  ...
  const header=`<header class="topbar site-topbar"><a class="wordmark" href="/">CPAPING</a><nav class="site-tabs" aria-label="주요 화면">${tabs}</nav>${status}<a class="site-login" id="auth-link" href="/login/">로그인</a><details id="account-menu" class="account-menu" hidden><summary><span id="account-nickname">닉네임 확인 중…</span></summary><div class="account-options"><a href="/account/">마이페이지</a><a href="/notifications/">알림설정</a><a href="/resume/">이력서</a><a href="/applications/">지원현황</a></div></details></header>`;
